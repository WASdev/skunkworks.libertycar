  ...
  <body>
    ...
    <script>
      ...
      require([
        ...
        "dojo/domReady!",
        "dojo/_base/json"
        ], function(array, dom, lang, on, has, ready, xhr){
          ready(function() {
            init(xhr);
          });
      });
    ...
    <div id="wrapper" align="center">
      ...
      <p style="font-size:15pt; font-family:arial">
        To drive hold your phone in landscape mode. <br/>Rotate left or right to control steering.<br/>
        Tilt top of phone away to accelerate forwards, and towards you to reverse.
      </p>
      <br/> 
